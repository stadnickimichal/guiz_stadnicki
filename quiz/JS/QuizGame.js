        ...
        loadJSON: function () {
            ...
            this.xobj.onreadystatechange = function () {
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    Game.ubdateText("Witamy w Quiz","Czy chcesz Wylosować swoje pytania i rozpocząc test ? Będziesz miał "+
                            that.time+"s żeby odpowiedzieć na "+that.Question.length+" pytań.",0);
                }
            };
